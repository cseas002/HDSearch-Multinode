...
mkdir -p ~/results/bucket/ADAPTIVE_FIXED2
mkdir -p ~/results/midtier/ADAPTIVE_FIXED2

# Check if the directory exists, if not, create it
ssh node2 'mkdir -p ~/results/ADAPTIVE_FIXED2'

nohup python3 run_experiment.py > ../no_pre.txt ADAPTIVE_FIXED2 &
...
scp node2:~/results/ADAPTIVE_FIXED2/wireshark.txt ~/results/ADAPTIVE_FIXED2/

scp node2:~/turbo* ~/results/bucket/ADAPTIVE_FIXED2/
scp node1:~/turbo* ~/results/midtier/ADAPTIVE_FIXED2/
...
mkdir -p ~/results
mkdir -p ~/results/bucket/WITHOUT_PRE_FIXED2
mkdir -p ~/results/midtier/WITHOUT_PRE_FIXED2

# Check if the directory exists, if not, create it
ssh node2 'mkdir -p ~/results/WITHOUT_PRE_FIXED2'

nohup python3 run_experiment.py > ../no_pre.txt WITHOUT_PRE_FIXED2 &


# NOW, YOU MUST WAIT
wait 
scp node2:~/turbo* ~/results/bucket/WITHOUT_PRE_FIXED2
scp node1:~/turbo* ~/results/midtier/WITHOUT_PRE_FIXED2
...
mkdir -p ~/results
mkdir -p ~/results/bucket/0US_PRE_FIXED2
mkdir -p ~/results/midtier/0US_PRE_FIXED2

# Check if the directory exists, if not, create it
ssh node2 'mkdir -p ~/results/0US_PRE_FIXED2'

nohup python3 run_experiment.py > ../no_pre.txt 0US_PRE_FIXED2 &


# NOW, YOU MUST WAIT
wait 
scp node2:~/turbo* ~/results/bucket/0US_PRE_FIXED2
scp node1:~/turbo* ~/results/midtier/0US_PRE_FIXED2
...
cd cseas_scripts
for name in ADAPTIVE_FIXED2 WITHOUT_PRE_FIXED2 0US_PRE_FIXED2 # 50US_PRE_FIXED 100US_PRE_FIXED 150US_PRE_FIXED
do
